 ...
 * Project:      Ethernet Media Access (MAC) Driver for
 *               STMicroelectronics STM32H7xx
 * -------------------------------------------------------------------------- */
...
- Version 1.7
  - Updated PHY_Read and PHY_Write functions (added check if Instance is valid)
- Version 1.6
...
/* Driver version */
#define ARM_ETH_MAC_DRV_VERSION         ARM_DRIVER_VERSION_MAJOR_MINOR(1,7)
