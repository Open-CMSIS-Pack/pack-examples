 ...
 * Project:      MCI Driver for STMicroelectronics STM32U5xx
 * -------------------------------------------------------------------------- */

/*! \page stm32u5_mci MCI
...
Optional configuration:
  ...
  - Data Cache Management:
    - **define Driver_MCI0_DCache {value}**
      - value 0U = disable MCI instance DCache maintenance operations
      - value 1U = enable  MCI instance DCache maintenance operations
      - default value is 1U
    - **define Driver_MCI1_DCache {value}**
      - value set as for MCI0 instance (see above)

# STM32U575I-EV Board Configuration
...
Link to [STM32U575I-EV board schematic](https://www.st.com/resource/en/schematic_pack/mb1550-u575aiq-c02_schematic.pdf).

## STM32CubeMX

Required peripherals for the **STM32U575I-EV** board are listed in the table below:

Peripheral | Mode                         | Description
:---------:|:----------------------------:|:-----------
SDMMC1     | SD 4 bits Wide bus           | SDMMC1 Controller
...
PI0        | GPIO_Input                   | Card Detect Pin
...
### Pinout & Configuration tab
  ...
  2. Under **Categories**: **Connectivity** select **SDMMC1**:
     ...
     __Configuration__:
       ...
       - GPIO Settings: review settings, no change required
            Pin Name | Signal on Pin | Pin Context..| Pin Priv..| GPIO output..| GPIO mode                     | GPIO Pull-up/Pull..| Maximum out..| Fast Mode | User Label
            :--------|:-------------:|:------------:|:---------:|:------------:|:-----------------------------:|:------------------:|:------------:|:---------:|:----------:
            PC8      | SDMMC1_D0     | n/a          | n/a       | n/a          | Alternate Function Push Pull  | No pull-up and no..| High         | n/a       | .
            PC9      | SDMMC1_D1     | n/a          | n/a       | n/a          | Alternate Function Push Pull  | No pull-up and no..| High         | n/a       | .
            PC10     | SDMMC1_D2     | n/a          | n/a       | n/a          | Alternate Function Push Pull  | No pull-up and no..| High         | n/a       | .
            PC11     | SDMMC1_D3     | n/a          | n/a       | n/a          | Alternate Function Push Pull  | No pull-up and no..| High         | n/a       | .
            PC12     | SDMMC1_CK     | n/a          | n/a       | n/a          | Alternate Function Push Pull  | No pull-up and no..| High         | n/a       | .
            PD2      | SDMMC1_CMD    | n/a          | n/a       | n/a          | Alternate Function Push Pull  | No pull-up and no..| High         | n/a       | .
       \n

  3. Under **Categories**: **System Core** select **GPIO**:
     __Configuration__:
       - GPIO:
            Pin Name | Signal on Pin | Pin Context..| Pin Priv..| GPIO output..| GPIO mode      | GPIO Pull-up/Pull..| Maximum out..| Fast Mode | User Label
            :--------|:-------------:|:------------:|:---------:|:------------:|:--------------:|:------------------:|:------------:|:---------:|:------------------:
            PI0      | n/a           | n/a          | n/a       | n/a          | **Input mode** | **Pull-up**        | n/a          | n/a       | **MemoryCard_CD0**
...
### Clock Configuration tab
  ...
  1. Configure **To SDMMC1,2 (MHz)**: **48**
...
/* MCI1: Define MemoryCard_MMC1 if SDMMC2 is configured for MMC device */
...
/* MCI0: DCACHE maintenance operations: 0U = disable, 1U = enable */
#if !defined(Driver_MCI0_DCache)
  #define MCI0_DCACHE_MAINTENANCE   1U
#else 
  #define MCI0_DCACHE_MAINTENANCE   Driver_MCI0_DCache
#endif

/* MCI1: DCACHE maintenance operations: 0U = disable, 1U = enable */
#if !defined(Driver_MCI1_DCache)
  #define MCI1_DCACHE_MAINTENANCE   1U
#else
  #define MCI1_DCACHE_MAINTENANCE   Driver_MCI1_DCache
#endif
...
#define MCI0_HANDLE_ADDR &hsd1
extern SD_HandleTypeDef   hsd1;
#else
#define MCI0_HANDLE_ADDR &hmmc1
extern MMC_HandleTypeDef  hmmc1;
#endif

#if (MCI_DCACHE != 0U) && (MCI0_DCACHE_MAINTENANCE != 0U)
  #define MCI0_DCACHE_HANDLE_ADDR &hdcache1
#else
  #define MCI0_DCACHE_HANDLE_ADDR NULL
#endif
...
#define MCI1_HANDLE_ADDR &hsd2
extern SD_HandleTypeDef   hsd2;
#else
#define MCI1_HANDLE_ADDR &hmmc2
extern MMC_HandleTypeDef  hmmc2;
#endif

#if (MCI_DCACHE != 0U) && (MCI1_DCACHE_MAINTENANCE != 0U)
  #define MCI1_DCACHE_HANDLE_ADDR &hdcache1
#else
  #define MCI1_DCACHE_HANDLE_ADDR NULL
#endif
...
#if defined(MX_DCACHE1) && (MX_DCACHE1 != 0U)
    if (mci->h_dcache != NULL) {
      /* DCache is present */
      if (HAL_DCACHE_IsEnabled(mci->h_dcache) == 1U) {
        /* Clean data cache:ensure data coherency between DMA and CPU */
        HAL_DCACHE_CleanByAddr (mci->h_dcache, (uint32_t *)daddr, block_count * block_size);
      }
    }
#endif
  }
  ...
  if (sta & SDMMC_STA_DATAEND) {
    ...
    if (mci->h_dcache != NULL) {
      ...
      if (HAL_DCACHE_IsEnabled(mci->h_dcache) == 1U) {
        ...
        HAL_DCACHE_InvalidateByAddr (mci->h_dcache, (uint32_t *)mci->reg->IDMABASER, mci->info->dlen);
      }
    }
#endif
  }
