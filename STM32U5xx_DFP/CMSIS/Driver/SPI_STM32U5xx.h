 ...
 * $Revision:    V1.0
 *
 * Project:      SPI Driver definitions for STMicroelectronics STM32U5xx
 * -------------------------------------------------------------------------- */

#ifndef __SPI_STM32U5XX_H
#define __SPI_STM32U5XX_H
...
#define SPIx_RESOURCE_ALLOC(x)          extern SPI_HandleTypeDef SPI##x##_HANDLE;             \
...
typedef struct {
  SPI_HandleTypeDef    *h;              // Handle
  SPI_TypeDef          *reg;            // Peripheral pointer
  SPI_PIN              *nss;            // NSS pin
