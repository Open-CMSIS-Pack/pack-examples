 ...
 * $Revision:    V1.1
 *
 * Project:      MCI Driver Definitions for STMicroelectronics STM32U5xx
 * -------------------------------------------------------------------------- */

#ifndef __MCI_STM32U5XX_H
#define __MCI_STM32U5XX_H
...
/* MCI: DCACHE maintenance must be configured in STMCubeMX */
#if defined(MX_DCACHE1) && (MX_DCACHE1 != 0U)
#define MCI_DCACHE          1U
#else
#define MCI_DCACHE          0U
#endif
