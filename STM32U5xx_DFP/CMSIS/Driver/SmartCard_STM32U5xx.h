 ...
 * $Revision:    V1.1
 *
 * Project:      SmartCard Driver definitions for STMicroelectronics STM32U5xx
 * -------------------------------------------------------------------------- */

#ifndef __SMARTCARD_STM32U5XX_H
#define __SMARTCARD_STM32U5XX_H
